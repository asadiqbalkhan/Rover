...
${OBJECTDIR}/SolarPanel.o: SolarPanel.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SolarPanel.o SolarPanel.cpp
...
${TESTDIR}/tests/TestRover.o: tests/TestRover.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/TestRover.o tests/TestRover.cpp


${TESTDIR}/tests/test_rover.cpp.o: tests/test_rover.cpp.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/test_rover.cpp.o tests/test_rover.cpp.cpp
...
${OBJECTDIR}/SolarPanel_nomain.o: ${OBJECTDIR}/SolarPanel.o SolarPanel.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SolarPanel_nomain.o SolarPanel.cpp;\
	else  \
